...
{
    public class FolderRepository : RepositoryBase<FolderModel>, IFolderRepository
    {
        public IQueryable<FolderModel> LoadAllByPage(out long total, int page, int rows, string order, string sort)
        {
