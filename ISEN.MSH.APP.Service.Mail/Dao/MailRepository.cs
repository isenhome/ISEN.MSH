...
{
    public class MailRepository : RepositoryBase<MailModel>, IMailRepository
    {
        public IQueryable<MailModel> LoadAllByPage(out long total, int page, int rows, string order, string sort)
        {
